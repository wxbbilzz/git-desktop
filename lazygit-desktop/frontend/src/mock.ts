...
function build(): RepoSnapshot {
  return {
    ...
    remotes: [
      { name: "origin", url: "https://github.com/you/demo.git", pushUrl: "" },
      { name: "upstream", url: "git@github.com:org/demo.git", pushUrl: "" },
    ],
    remoteBranches: [
      {
        name: "origin/feature/rounded-ui",
        short: "feature/rounded-ui",
        remote: "origin",
        hash: "9f2c41b7a8e5d3c1f0a9b8c7d6e5f4a3b2c1d0e9",
        shortHash: "9f2c41b",
        subject: "抽出无界面引擎，与 UI 解耦",
        when: "12 分钟前",
        isCurrentUpstream: true,
        hasLocal: true,
      },
      {
        name: "origin/main",
